    ...
    <div class="max-w-[1200px] mx-auto space-y-12 px-4 sm:px-8 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div v-reveal="{ delay: 200 }" class="lg:col-span-1 space-y-6">
          <div class="bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/20 dark:border-white/5 rounded-xl p-8 shadow-2xl relative overflow-hidden group">
            ...
            <div class="flex flex-col items-center text-center space-y-6">
              <div class="relative group">
                <div class="w-32 h-32 rounded-xl bg-gradient-to-br from-[#6a0d5f] to-[#8a1a7a] flex items-center justify-center text-white text-4xl font-black shadow-2xl transition-transform duration-500 group-hover:scale-105 group-hover:rotate-3">
                  {{ form.prenom?.charAt(0) }}{{ form.nom?.charAt(0) }}
                </div>
                <div class="absolute -bottom-2 -right-2 w-10 h-10 bg-emerald-500 rounded-xl border-4 border-white dark:border-gray-900 flex items-center justify-center shadow-lg">
              ...
              <div class="space-y-1">
                <h3 class="text-2xl font-black text-gray-900 dark:text-white uppercase tracking-tighter leading-tight">{{ form.prenom }} {{ form.nom }}</h3>
              ...
              <div class="w-full pt-6 border-t border-gray-100 dark:border-white/5 grid grid-cols-1 gap-4">
                <div class="flex items-center gap-3 px-4 py-3 bg-gray-50/50 dark:bg-white/5 rounded-xl">
        ...
        <div v-reveal="{ delay: 400 }" class="lg:col-span-2 space-y-12">
          <!-- Identity Info Form -->
          <div class="bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/20 dark:border-white/5 rounded-xl p-10 shadow-2xl relative overflow-hidden group">
            <div class="mb-8">
              <h4 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Informations Personnelles</h4>
            ...
            <form @submit.prevent="updateProfile" class="space-y-8">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                  ...
                  <input v-model="form.nom" type="text" class="w-full px-6 py-4 bg-white/60 dark:bg-gray-800/40 border border-white/30 dark:border-white/5 rounded-xl focus:ring-2 focus:ring-[#6a0d5f] transition-all outline-none text-sm font-bold text-gray-700 dark:text-gray-200" />
                </div>
                <div class="space-y-2">
                  <label class="text-[10px] font-black uppercase tracking-widest text-[#6a0d5f] ml-1">Prénom</label>
                  <input v-model="form.prenom" type="text" class="w-full px-6 py-4 bg-white/60 dark:bg-gray-800/40 border border-white/30 dark:border-white/5 rounded-xl focus:ring-2 focus:ring-[#6a0d5f] transition-all outline-none text-sm font-bold text-gray-700 dark:text-gray-200" />
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                  ...
                  <input v-model="form.email" type="email" class="w-full px-6 py-4 bg-white/60 dark:bg-gray-800/40 border border-white/30 dark:border-white/5 rounded-xl focus:ring-2 focus:ring-[#6a0d5f] transition-all outline-none text-sm font-bold text-gray-700 dark:text-gray-200" />
                </div>
                <div class="space-y-2">
                  <label class="text-[10px] font-black uppercase tracking-widest text-[#6a0d5f] ml-1">N° de téléphone</label>
                  <input v-model="form.telephone" type="text" class="w-full px-6 py-4 bg-white/60 dark:bg-gray-800/40 border border-white/30 dark:border-white/5 rounded-xl focus:ring-2 focus:ring-[#6a0d5f] transition-all outline-none text-sm font-bold text-gray-700 dark:text-gray-200" />
                </div>
              </div>
              ...
              <div class="pt-4">
                <button 
                  ...
                  class="px-10 py-4 bg-[#6a0d5f] text-white rounded-xl font-black text-[10px] uppercase tracking-[0.2em] shadow-lg shadow-[#6a0d5f]/30 hover:scale-105 active:scale-95 transition-all flex items-center gap-3 disabled:opacity-50"
                >
          ...
          <div class="bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl border border-white/20 dark:border-white/5 rounded-xl p-10 shadow-2xl relative overflow-hidden group">
            <div class="mb-8">
              <h4 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Sécurité et Mot de Passe</h4>
              ...
              <div class="space-y-2">
                ...
                <div class="relative">
                  <input 
                    ...
                    class="w-full px-6 py-4 bg-white/60 dark:bg-gray-800/40 border border-white/30 dark:border-white/5 rounded-xl focus:ring-2 focus:ring-[#6a0d5f] transition-all outline-none text-sm font-bold text-gray-700 dark:text-gray-200" 
                  />
