        ...
        <div class="flex-1 p-8 md:p-14 flex flex-col justify-center">
          ...
          <form @submit.prevent="handleLogin" class="space-y-6">
            ...
            <button :disabled="auth.loading"
              class="w-full bg-[#6a0d5f] text-white py-5 font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-[#6a0d5f]/20 hover:bg-[#851178] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-300 disabled:opacity-60 flex items-center justify-center gap-2">
